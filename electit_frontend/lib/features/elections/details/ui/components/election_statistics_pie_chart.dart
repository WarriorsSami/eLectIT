...
import 'package:electit_frontend/features/shared/domain/helpers.dart';
import 'package:fl_chart/fl_chart.dart';
import 'package:flutter/material.dart';

class ElectionStatisticsPieChart extends StatefulWidget {
  final ElectionStatistics statistics;

  const ElectionStatisticsPieChart({
...
class ElectionStatisticsState extends State<ElectionStatisticsPieChart> {
  int touchedIndex = 0;
  ...
  List<PieChartSectionData> showingSections() {
    final colors = getRandomDifferentColors(
