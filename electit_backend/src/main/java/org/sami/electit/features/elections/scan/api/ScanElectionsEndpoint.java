package org.sami.electit.features.elections.scan.api;

import org.sami.electit.features.elections.scan.application.ScanElectionsUseCase;
...
public class ScanElectionsEndpoint {
	...
	public Flux<ElectionDTO> elections() {
		return scanElectionsUseCase.execute();
	}
}
